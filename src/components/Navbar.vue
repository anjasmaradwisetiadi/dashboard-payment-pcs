<template>
    <div id="Navbar">
        <transition name="fade" v-if="nameRoutePath === 'dashboard'">
            <div class="w-screen flex flex-row justify-between title text-center pb-3 pt-2 mb-8 px-3 z-10 fixed bg-white ">
        ...
        <transition name="fade" v-if="nameRoutePath === 'notification'">
                <div class="flex justify-start w-screen flex-row title text-center pb-3 pt-2 border-b-2 mb-8 px-3 border-t z-10 fixed bg-white shadow-md">
